...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference("Opportunity.count") do
      post opportunities_url, params: { opportunity: { account_id: @opportunity.account_id, name: @opportunity.name, value: @opportunity.value } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { account_id: @opportunity.account_id, name: @opportunity.name, value: @opportunity.value } }
